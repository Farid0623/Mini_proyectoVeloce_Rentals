...
public class ShowVehiclesServlet extends HttpServlet{
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            List<ProductDto> filteredVehicles = vehicleDtos.stream()
                    ...
                    .filter(vehicleDto -> type == null || type.isEmpty() || Objects.equals(vehicleDto.type(), type))
                    .filter(vehicleDto -> brand == null || brand.isEmpty() || Objects.equals(vehicleDto.type(), brand))
            ...
            try (PrintWriter out = resp.getWriter()) {
                ...
                for (ProductDto vehicleDto : filteredVehicles) {
                    ...
                    out.println("                <td>" + vehicleDto.name() + "</td>");
